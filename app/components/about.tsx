    ...
    <div>
        <Popover> 
            <div className='relative group'>
                ...
                <PopoverContent className="ml-[350px] -mb-[4%] ">
                <div className='text-white flex justify-between'>
                    <div className="w-[60%]">
                        <h2 className='text-blue-400 my-2 underline-offset-1'>ABOUT ME</h2>
                        <p className='my-4'>
                    ...
                    <Image src='/image.webp' alt='about-image' width={300} height={5}></Image>
                </div>
                </PopoverContent>
            </div>
        </Popover>
