        ...
        <div>
            <div className="bg-[#111] text-white p-2">
                <div className='flex justify-between'>
                    <h2 className='text-blue-400 my-2'><u>ABOUT ME</u></h2>
                ...
                <h2 className='text-blue-400 mt-8 text-center'><u>FRONT-END DEVELOPER</u></h2>
                <Image src='/image.webp' alt='about-image' width={250} height={5} className='mx-auto mt-6'></Image>
                <div className='flex space-x-6 justify-around my-4'>
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger>
